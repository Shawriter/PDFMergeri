...
try:
    ...
    class Mergergui(Frame, Menu):
        ...
        def __init__(self, master=None):
            ...
            # Had to use lambda, because couldn't call a function normally
            self.menubar.add_command(label="Help/Usage", command=lambda: self.help())
            ...
            self.AddButton1 = ttk.Button(self, text="Clear filelist", command=self.clear_list)
            ...
            self.AddButton2 = ttk.Button(self, text="Add PDFs", command=self.files)
            ...
            self.mergeButton = ttk.Button(self, text="Merge", command=self.mergeri)
                ...
                for self.formaatti in self.kuvat2:
                    ...
                    if self.muoto == "jpeg":
                        ...
                        if os.path.exists(self.tiedostonimi):
                            ...
                            for dirname, subdirs, files in os.walk("."):  # Luodaan tiedostonimi
                                for fname in files:
